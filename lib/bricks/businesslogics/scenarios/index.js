...
class Scenarios extends Base {
  constructor(cementHelper, configuration) {
    ...
    this.apiURLs.schedulerApiUrl =
      configuration.properties && configuration.properties.schedulerApiUrl || this.cementHelper.cement.configuration.properties.schedulerApiUrl;
    this.apiURLs.scenarioApiUrl =
      configuration.properties && configuration.properties.scenarioApiUrl || this.cementHelper.cement.configuration.properties.scenarioApiUrl;
